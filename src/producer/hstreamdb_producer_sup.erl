...
batch_aggregator_pool_spec(Producer, PoolSize, Opts) ->
    ...
    PoolOpts = [
        {pool_size, PoolSize}, {pool_type, hash}, {auto_reconnect, AutoReconnect}, {opts, Opts}
    ],
...
batch_writer_pool_spec(Producer, PoolSize, Opts) ->
    ...
    ecpool_spec(
        hstreamdb_batch_aggregator:writer_name(Producer), hstreamdb_batch_writer, WriterOptions
    ).
