...
handle_cast(
    {write_result, ShardId, BatchId, Result},
    ...
    KeysToFlush =
        case WhichKeys of
            deadline ->
                ...
                [
                    ShardId
                 || {ShardId, Deadline} <- maps:to_list(FlushDeadlineMap),
...
do_flush_key(
    ...
    State1#state{
        record_map = maps:remove(ShardId, RecordMap),
